...
function OneOf(props) {
    ...
    // oneOf选项卡的index
    var _a = react_1.useState($oneOfIndex !== undefined && lodash_1.isNumber($oneOfIndex) ? $oneOfIndex : 0), index = _a[0], setIndex = _a[1];
    // 切换的callback
    ...
    react_1.useEffect(function () {
        setIndex($oneOfIndex !== undefined && lodash_1.isNumber($oneOfIndex) ? $oneOfIndex : 0);
    }, [root]);
    // 渲染radio
